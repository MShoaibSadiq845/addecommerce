    ...
    <footer className="w-full bg-[#f0f0f0] pt-14 pb-8 font-['Satoshi'] text-black">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 border-b border-gray-300 pb-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            {footerLinks.company.map(({ label, href }) => (
              <Link key={label} href={href} className="text-sm text-gray-600 hover:text-black transition-colors">
                {label}
              </Link>
            ))}
          </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center sm:gap-4 text-xs text-gray-500 gap-1 text-center sm:text-left">
            <p>
            ...
            <a
              href="https://wa.me/923281298871?text=Hi%20Shoaib,%20I%20saw%20your%20credit%20on%20FabDecor%20and%20want%20to%20get%20a%20website%20built."
              target="_blank"
              rel="noopener noreferrer"
