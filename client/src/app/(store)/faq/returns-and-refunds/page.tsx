      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col gap-4">
        ...
        <ol className="flex flex-col gap-4">
          {[
            ...
            { step: '4', title: 'Refund Processed', desc: 'Once we receive and inspect the returned item (3–5 business days), your refund will be initiated within 5–7 business days.' },
          ].map(({ step, title, desc }) => (
