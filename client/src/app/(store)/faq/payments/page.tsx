  ...
  return (
    <div className="w-full max-w-[860px] mx-auto px-4 py-12 font-['Satoshi'] flex flex-col gap-10">
      ...
      <div className="flex gap-3 bg-amber-50 border border-amber-200 rounded-2xl p-4">
        ...
        <p className="text-sm text-amber-800">For payment issues, contact us at <a href="mailto:fabdecor09@gmail.com" className="font-semibold underline">fabdecor09@gmail.com</a> or call <a href="tel:+923291747459" className="font-semibold underline">0329-1747459</a>.</p>
      </div>
    </div>
  );
}
