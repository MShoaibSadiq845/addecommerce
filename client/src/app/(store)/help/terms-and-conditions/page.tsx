    ...
    <div className="w-full max-w-[860px] mx-auto px-4 py-12 font-['Satoshi'] flex flex-col gap-8">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm flex flex-col gap-7">
        <Section title="1. Acceptance of Terms">
          By accessing or using FabDecor, you agree to be bound by these Terms and Conditions and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using this site.
        </Section>
        ...
        <Section title="3. Orders & Payment">
          <ul className="list-disc pl-4 flex flex-col gap-1.5">
            ...
            <li>FabDecor reserves the right to cancel any order suspected of fraud.</li>
            <li>You will receive an email confirmation upon successful order placement.</li>
          </ul>
        </Section>

        <Section title="4. Shipping & Delivery">
          Delivery timelines are estimates and may vary. FabDecor is not responsible for delays caused by courier partners, natural disasters, or government restrictions. See our <Link href="/help/delivery-details" className="underline font-semibold text-black">Delivery Details</Link> page for full information.
        </Section>
        ...
        <Section title="8. Limitation of Liability">
          FabDecor shall not be liable for any indirect, incidental, or consequential damages arising from the use or inability to use our services. Our maximum liability is limited to the amount paid for the specific order in question.
        </Section>
        ...
        <Section title="10. Contact">
          ...
          <a href="mailto:fabdecor09@gmail.com" className="underline font-semibold text-black">fabdecor09@gmail.com</a>{' '}
          or call <a href="tel:+923291747459" className="underline font-semibold text-black">0329-1747459</a>.
        </Section>
      </div>
    </div>
  );
